...
Debug.ShouldStop(16777216);
 BA.debugLineNum = 91;BA.debugLine="Activity.LoadLayout(\"Pantalla1\")";
...
if (_firsttime.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 94;BA.debugLine="formatter.Initialize";
Debug.ShouldStop(536870912);
main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_initialize" /*RemoteObject*/ ,main.processBA);
 BA.debugLineNum = 95;BA.debugLine="Dim DefaultFormat As B4XFormatData = formatter.G";
...
_defaultformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ );Debug.locals.put("DefaultFormat", _defaultformat);Debug.locals.put("DefaultFormat", _defaultformat);
 BA.debugLineNum = 96;BA.debugLine="DefaultFormat.MaximumFractions = 2";
Debug.ShouldStop(-2147483648);
_defaultformat.setField ("MaximumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 97;BA.debugLine="DefaultFormat.MinimumFractions = 2";
Debug.ShouldStop(1);
_defaultformat.setField ("MinimumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 98;BA.debugLine="DefaultFormat.Prefix = \"$ \"";
Debug.ShouldStop(2);
_defaultformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ "));
 BA.debugLineNum = 99;BA.debugLine="Dim NegativeFormat As B4XFormatData = formatter.";
Debug.ShouldStop(4);
_negativeformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(_defaultformat));Debug.locals.put("NegativeFormat", _negativeformat);Debug.locals.put("NegativeFormat", _negativeformat);
 BA.debugLineNum = 100;BA.debugLine="NegativeFormat.TextColor = xui.Color_Red";
Debug.ShouldStop(8);
_negativeformat.setField ("TextColor" /*RemoteObject*/ ,main._xui.getField(true,"Color_Red"));
 BA.debugLineNum = 101;BA.debugLine="NegativeFormat.Prefix = \"$ (\"";
Debug.ShouldStop(16);
_negativeformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ ("));
 BA.debugLineNum = 102;BA.debugLine="NegativeFormat.Postfix = \")\"";
Debug.ShouldStop(32);
_negativeformat.setField ("Postfix" /*RemoteObject*/ ,BA.ObjectToString(")"));
 BA.debugLineNum = 103;BA.debugLine="NegativeFormat.FormatFont = xui.CreateDefaultBol";
Debug.ShouldStop(64);
_negativeformat.setField ("FormatFont" /*RemoteObject*/ ,main._xui.runMethod(false,"CreateDefaultBoldFont",(Object)(BA.numberCast(float.class, 15))));
 BA.debugLineNum = 104;BA.debugLine="formatter.AddFormatData(NegativeFormat, formatte";
...
try {
		Debug.PushSubsStack("Activity_Pause (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,113);
...
try {
		Debug.PushSubsStack("Activity_Resume (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,109);
...
try {
		Debug.PushSubsStack("Analisis_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,153);
...
RemoteObject _cell = RemoteObject.declareNull("de.donmanfred.XSSFCellwrapper");
 BA.debugLineNum = 153;BA.debugLine="Private Sub Analisis_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 155;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(67108864);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 156;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 158;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(536870912);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 159;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(1073741824);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 161;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
Debug.ShouldStop(1);
...
_sheet = main._xls.runMethod(false,"getSheetAt",(Object)(main._xls.runMethod(true,"getActiveSheetIndex")));Debug.locals.put("sheet", _sheet);Debug.locals.put("sheet", _sheet);
 BA.debugLineNum = 164;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(8);
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 165;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(16);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 167;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(64);
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
 BA.debugLineNum = 172;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(2048);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 173;BA.debugLine="GOp = Cell.NumericCellValue";
Debug.ShouldStop(4096);
main._gop = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 175;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(16384);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
 BA.debugLineNum = 176;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(32768);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 177;BA.debugLine="UtilidadB = Cell.NumericCellValue";
Debug.ShouldStop(65536);
main._utilidadb = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 179;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(262144);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
 BA.debugLineNum = 180;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(524288);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 181;BA.debugLine="Gadm = Cell.NumericCellValue";
Debug.ShouldStop(1048576);
main._gadm = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 183;BA.debugLine="row=sheet.getRow(5)";
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
 BA.debugLineNum = 184;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(8388608);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 185;BA.debugLine="UtilidadOai = Cell.NumericCellValue";
Debug.ShouldStop(16777216);
main._utilidadoai = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 187;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(67108864);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
 BA.debugLineNum = 188;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(134217728);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 189;BA.debugLine="Impuestos = Cell.NumericCellValue";
Debug.ShouldStop(268435456);
main._impuestos = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 191;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(1073741824);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 192;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(-2147483648);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 193;BA.debugLine="UOperativaDesp_Imp = Cell.NumericCellValue";
Debug.ShouldStop(1);
main._uoperativadesp_imp = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
...
try {
		Debug.PushSubsStack("Boton_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,133);
...
_fd.setField ("TextColor",parent.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 138;BA.debugLine="fd.FilePath = File.DirInternal";
Debug.ShouldStop(512);
_fd.runMethod(true,"setFilePath",parent.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal"));
 BA.debugLineNum = 139;BA.debugLine="Dim sf As Object = fd.ShowAsync(\"Seleccionar Arch";
Debug.ShouldStop(1024);
_sf = _fd.runMethod(false,"ShowAsync",(Object)(BA.ObjectToCharSequence("Seleccionar Archivo")),(Object)(BA.ObjectToString("SELECCIONAR")),(Object)(BA.ObjectToString("Cancelar")),(Object)(BA.ObjectToString("si")),main.mostCurrent.activityBA,(Object)((parent.mostCurrent.__c.getField(false,"Null"))),(Object)(parent.mostCurrent.__c.getField(true,"False")));Debug.locals.put("sf", _sf);Debug.locals.put("sf", _sf);
 BA.debugLineNum = 140;BA.debugLine="Wait For (sf) Dialog_Result(Result As Int)";
Debug.ShouldStop(2048);
...
//C
this.state = 4;
 BA.debugLineNum = 142;BA.debugLine="Log(\"File path: \" & fd.FilePath)";
Debug.ShouldStop(8192);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1458761",RemoteObject.concat(RemoteObject.createImmutable("File path: "),_fd.runMethod(true,"getFilePath")),0);
 BA.debugLineNum = 143;BA.debugLine="archivo = fd.ChosenName";
Debug.ShouldStop(16384);
parent.mostCurrent._archivo = _fd.runMethod(true,"getChosenName");
 BA.debugLineNum = 144;BA.debugLine="Log(\"File name: \" & archivo)";
Debug.ShouldStop(32768);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1458763",RemoteObject.concat(RemoteObject.createImmutable("File name: "),parent.mostCurrent._archivo),0);
 if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 146;BA.debugLine="Label1.Text = \"Ruta = \" & fd.FilePath";
...
parent.mostCurrent._label1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Ruta = "),_fd.runMethod(true,"getFilePath"))));
 BA.debugLineNum = 147;BA.debugLine="Label2.Text = \"Archivo = \" & fd.ChosenName";
Debug.ShouldStop(262144);
parent.mostCurrent._label2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Archivo = "),_fd.runMethod(true,"getChosenName"))));
 BA.debugLineNum = 149;BA.debugLine="Log(\"File path: \" & archivo)";
Debug.ShouldStop(1048576);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1458768",RemoteObject.concat(RemoteObject.createImmutable("File path: "),parent.mostCurrent._archivo),0);
...
try {
		Debug.PushSubsStack("ER_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,198);
...
RemoteObject _texto1 = RemoteObject.createImmutable("");
 BA.debugLineNum = 198;BA.debugLine="Private Sub ER_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 199;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(64);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 200;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(128);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 202;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
Debug.ShouldStop(512);
_sheet = RemoteObject.createNew ("de.donmanfred.XLSSheetwrapper");
_sheet = main._xls.runMethod(false,"getSheetAt",(Object)(main._xls.runMethod(true,"getActiveSheetIndex")));Debug.locals.put("sheet", _sheet);Debug.locals.put("sheet", _sheet);
...
Debug.ShouldStop(8192);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 207;BA.debugLine="Activity.LoadLayout(\"EstadoResultados\")";
Debug.ShouldStop(16384);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("EstadoResultados")),main.mostCurrent.activityBA);
 BA.debugLineNum = 208;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(32768);
_row = RemoteObject.createNew ("de.donmanfred.XSSFRowwrapper");
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 209;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(65536);
_cell = RemoteObject.createNew ("de.donmanfred.XSSFCellwrapper");
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 211;BA.debugLine="Dim Texto1 As String = NumberFormat2(0, 1, 2, 2,";
Debug.ShouldStop(262144);
_texto1 = main.mostCurrent.__c.runMethod(true,"NumberFormat2",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 2)),(Object)(BA.numberCast(int.class, 2)),(Object)(main.mostCurrent.__c.getField(true,"False")));Debug.locals.put("Texto1", _texto1);Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 212;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(524288);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 213;BA.debugLine="Concepto.text= Texto1";
Debug.ShouldStop(1048576);
main.mostCurrent._concepto.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 215;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(4194304);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 1))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(16777216);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 219;BA.debugLine="Concepto1.text= Texto1";
Debug.ShouldStop(67108864);
main.mostCurrent._concepto1.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 221;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(268435456);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(1073741824);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 224;BA.debugLine="Concepto2.text= Texto1";
Debug.ShouldStop(-2147483648);
main.mostCurrent._concepto2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 226;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(2);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
 BA.debugLineNum = 227;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(4);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 228;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(8);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 229;BA.debugLine="Concepto3.text= Texto1";
Debug.ShouldStop(16);
main.mostCurrent._concepto3.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 231;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(64);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(256);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 234;BA.debugLine="Concepto4.text= Texto1";
Debug.ShouldStop(512);
main.mostCurrent._concepto4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 236;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(2048);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
 BA.debugLineNum = 237;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(4096);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 238;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(8192);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 239;BA.debugLine="Concepto5.text= Texto1";
Debug.ShouldStop(16384);
main.mostCurrent._concepto5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 241;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(65536);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
 BA.debugLineNum = 242;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(131072);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 243;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(262144);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 244;BA.debugLine="Concepto6.text= Texto1";
Debug.ShouldStop(524288);
main.mostCurrent._concepto6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 246;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(2097152);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 247;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(4194304);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 248;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(8388608);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 249;BA.debugLine="Concepto7.text= Texto1";
Debug.ShouldStop(16777216);
main.mostCurrent._concepto7.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 251;BA.debugLine="row=sheet.getRow(0)";
Debug.ShouldStop(67108864);
...
Debug.ShouldStop(134217728);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 253;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(268435456);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 254;BA.debugLine="Datos.text= Texto1";
Debug.ShouldStop(536870912);
main.mostCurrent._datos.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 256;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(-2147483648);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 1))));Debug.locals.put("row", _row);
 BA.debugLineNum = 257;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 258;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(2);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 259;BA.debugLine="Datos1.text= Texto1";
Debug.ShouldStop(4);
main.mostCurrent._datos1.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 261;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(16);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(64);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 264;BA.debugLine="Datos2.text= Texto1";
Debug.ShouldStop(128);
main.mostCurrent._datos2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 266;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(512);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
 BA.debugLineNum = 267;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1024);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 268;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(2048);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 269;BA.debugLine="Datos3.text= Texto1";
Debug.ShouldStop(4096);
main.mostCurrent._datos3.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 271;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(16384);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(65536);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 274;BA.debugLine="Datos4.text= Texto1";
Debug.ShouldStop(131072);
main.mostCurrent._datos4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 276;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(524288);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
 BA.debugLineNum = 277;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1048576);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 278;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(2097152);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 279;BA.debugLine="Datos5.text= Texto1";
Debug.ShouldStop(4194304);
main.mostCurrent._datos5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 281;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(16777216);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
 BA.debugLineNum = 282;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(33554432);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 283;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(67108864);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 284;BA.debugLine="Datos6.text= Texto1";
Debug.ShouldStop(134217728);
main.mostCurrent._datos6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 286;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(536870912);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 287;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1073741824);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 288;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(-2147483648);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 289;BA.debugLine="Datos7.text= Texto1";
Debug.ShouldStop(1);
...
main._utilidadb = RemoteObject.createImmutable(0f);
main._utilidadoai = RemoteObject.createImmutable(0f);
main._impuestos = RemoteObject.createImmutable(0f);
main._uoperativadesp_imp = RemoteObject.createImmutable(0f);
...
main.mostCurrent._regresar2 = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 81;BA.debugLine="Private infoUB As Button";
main.mostCurrent._infoub = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 82;BA.debugLine="Private infoUM As Button";
main.mostCurrent._infoum = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 83;BA.debugLine="Private ScrollView1 As HorizontalScrollView";
main.mostCurrent._scrollview1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.HorizontalScrollViewWrapper");
 //BA.debugLineNum = 84;BA.debugLine="Private Panelbarras As Panel";
main.mostCurrent._panelbarras = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
 //BA.debugLineNum = 85;BA.debugLine="Private HScrooll As HorizontalScrollView";
main.mostCurrent._hscrooll = RemoteObject.createNew ("anywheresoftware.b4a.objects.HorizontalScrollViewWrapper");
 //BA.debugLineNum = 86;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _info_click() throws Exception{
try {
		Debug.PushSubsStack("info_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,127);
if (RapidSub.canDelegate("info_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","info_click");}
 BA.debugLineNum = 127;BA.debugLine="Private Sub info_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 128;BA.debugLine="MsgboxAsync(\"Recuerda verificar que el archivo ele";
Debug.ShouldStop(-2147483648);
...
public static RemoteObject  _infoub_click() throws Exception{
try {
		Debug.PushSubsStack("infoUB_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,356);
if (RapidSub.canDelegate("infoub_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoub_click");}
 BA.debugLineNum = 356;BA.debugLine="Private Sub infoUB_Click";
Debug.ShouldStop(8);
...
public static RemoteObject  _infoum_click() throws Exception{
try {
		Debug.PushSubsStack("infoUM_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,360);
if (RapidSub.canDelegate("infoum_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoum_click");}
 BA.debugLineNum = 360;BA.debugLine="Private Sub infoUM_Click";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("Ingresos_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,298);
if (RapidSub.canDelegate("ingresos_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","ingresos_click");}
 BA.debugLineNum = 298;BA.debugLine="Private Sub Ingresos_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 299;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(1024);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 301;BA.debugLine="Activity.LoadLayout(\"Scroll\")";
Debug.ShouldStop(4096);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Scroll")),main.mostCurrent.activityBA);
 BA.debugLineNum = 302;BA.debugLine="HScrooll.Panel.LoadLayout(\"ingresos_gastos\")";
Debug.ShouldStop(8192);
main.mostCurrent._hscrooll.runMethod(false,"getPanel").runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("ingresos_gastos")),main.mostCurrent.activityBA);
 BA.debugLineNum = 303;BA.debugLine="HScrooll.Panel.Width=Panelbarras.Width";
Debug.ShouldStop(16384);
main.mostCurrent._hscrooll.runMethod(false,"getPanel").runMethod(true,"setWidth",main.mostCurrent._panelbarras.runMethod(true,"getWidth"));
 BA.debugLineNum = 315;BA.debugLine="mbc1.LegendShapeSize = 7.0	    'this line of code";
Debug.ShouldStop(67108864);
main.mostCurrent._mbc1.runVoidMethod ("setLegendShapeSize",BA.numberCast(float.class, 7.0));
 BA.debugLineNum = 316;BA.debugLine="mbc1.setTheLegendPositionAndForm(\"BELOW_CHART_CEN";
Debug.ShouldStop(134217728);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendPositionAndForm",(Object)(BA.ObjectToString("BELOW_CHART_CENTER")),(Object)(RemoteObject.createImmutable("CIRCLE")));
 BA.debugLineNum = 318;BA.debugLine="mbc1.TheLegendColor = Colors.Gray";
Debug.ShouldStop(536870912);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 319;BA.debugLine="mbc1.TheLegendTextSize = 13.0";
Debug.ShouldStop(1073741824);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendTextSize",BA.numberCast(float.class, 13.0));
 BA.debugLineNum = 320;BA.debugLine="mbc1.LegendTitle = \"\"";
Debug.ShouldStop(-2147483648);
main.mostCurrent._mbc1.runVoidMethod ("setLegendTitle",BA.ObjectToString(""));
 BA.debugLineNum = 321;BA.debugLine="mbc1.ChartDescription = \"\"";
Debug.ShouldStop(1);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescription",BA.ObjectToString(""));
 BA.debugLineNum = 322;BA.debugLine="mbc1.ChartDescriptionColor = 0XFFFFA500";
Debug.ShouldStop(2);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionColor",BA.numberCast(int.class, ((int)0xffffa500)));
 BA.debugLineNum = 323;BA.debugLine="mbc1.ChartDescriptionTextSize = 13";
Debug.ShouldStop(4);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionTextSize",BA.numberCast(float.class, 13));
 BA.debugLineNum = 325;BA.debugLine="mbc1.ValueTextColor = Colors.Red";
Debug.ShouldStop(16);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));
 BA.debugLineNum = 326;BA.debugLine="mbc1.ValueTextSize = 6.0";
Debug.ShouldStop(32);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextSize",BA.numberCast(int.class, 6.0));
 BA.debugLineNum = 329;BA.debugLine="mbc1.BarColors = Array As Int(Colors.Blue, Colors";
Debug.ShouldStop(256);
main.mostCurrent._mbc1.runVoidMethod ("setBarColors",RemoteObject.createNewArray("int",new int[] {7},new Object[] {main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"DarkGray"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue")}));
 BA.debugLineNum = 330;BA.debugLine="mbc1.LegendText = Array As String(\"Ingresos\", \"G,";
Debug.ShouldStop(512);
main.mostCurrent._mbc1.runVoidMethod ("setLegendText",RemoteObject.createNewArray("String",new int[] {7},new Object[] {BA.ObjectToString("Ingresos"),BA.ObjectToString("G,Operacionales"),BA.ObjectToString("Utilidad Bruta"),BA.ObjectToString("G. Admin."),BA.ObjectToString("Utilidad Operativa AI."),BA.ObjectToString("Impuestos"),RemoteObject.createImmutable("Utilidad O. Desp Impuestos")}));
 BA.debugLineNum = 331;BA.debugLine="mbc1.ChartData = Array As Float (Ingresos_, GOp,";
Debug.ShouldStop(1024);
main.mostCurrent._mbc1.runVoidMethod ("setChartData",RemoteObject.createNewArray("float",new int[] {7},new Object[] {main._ingresos_,main._gop,main._utilidadb,main._gadm,main._utilidadoai,main._impuestos,main._uoperativadesp_imp}));
 BA.debugLineNum = 332;BA.debugLine="mbc1.LegendShapeSize=5";
Debug.ShouldStop(2048);
main.mostCurrent._mbc1.runVoidMethod ("setLegendShapeSize",BA.numberCast(float.class, 5));
 BA.debugLineNum = 334;BA.debugLine="mbc1.DoubleTapToZoomEnabled = True";
Debug.ShouldStop(8192);
main.mostCurrent._mbc1.runVoidMethod ("setDoubleTapToZoomEnabled",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 335;BA.debugLine="mbc1.DrawBarShadow = False";
Debug.ShouldStop(16384);
main.mostCurrent._mbc1.runVoidMethod ("setDrawBarShadow",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 336;BA.debugLine="mbc1.GridBackgroundColor = Colors.Black";
Debug.ShouldStop(32768);
main.mostCurrent._mbc1.runVoidMethod ("setGridBackgroundColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 337;BA.debugLine="mbc1.ValueTextColor = 0XFFFFA500";
Debug.ShouldStop(65536);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextColor",BA.numberCast(int.class, ((int)0xffffa500)));
 BA.debugLineNum = 338;BA.debugLine="mbc1.DrawBorders = True";
Debug.ShouldStop(131072);
main.mostCurrent._mbc1.runVoidMethod ("setDrawBorders",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 339;BA.debugLine="mbc1.DrawGridBackground = True";
Debug.ShouldStop(262144);
main.mostCurrent._mbc1.runVoidMethod ("setDrawGridBackground",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 340;BA.debugLine="mbc1.DrawHighlightArrow = True";
Debug.ShouldStop(524288);
main.mostCurrent._mbc1.runVoidMethod ("setDrawHighlightArrow",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 341;BA.debugLine="mbc1.DrawValueAboveBar = True";
Debug.ShouldStop(1048576);
main.mostCurrent._mbc1.runVoidMethod ("setDrawValueAboveBar",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 342;BA.debugLine="mbc1.PinchZoom = True";
Debug.ShouldStop(2097152);
main.mostCurrent._mbc1.runVoidMethod ("setPinchZoom",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 343;BA.debugLine="mbc1.ScaleEnabled = True";
Debug.ShouldStop(4194304);
main.mostCurrent._mbc1.runVoidMethod ("setScaleEnabled",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 344;BA.debugLine="mbc1.BorderColor = Colors.Blue";
Debug.ShouldStop(8388608);
main.mostCurrent._mbc1.runVoidMethod ("setBorderColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 345;BA.debugLine="mbc1.BorderWidth = 4.0";
Debug.ShouldStop(16777216);
main.mostCurrent._mbc1.runVoidMethod ("setBorderWidth",BA.numberCast(float.class, 4.0));
 BA.debugLineNum = 347;BA.debugLine="mbc1.BarData = 7   'this number must be the same";
Debug.ShouldStop(67108864);
main.mostCurrent._mbc1.runVoidMethod ("setBarData",BA.numberCast(int.class, 7));
...
try {
		Debug.PushSubsStack("INICIAR_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,117);
if (RapidSub.canDelegate("iniciar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","iniciar_click");}
 BA.debugLineNum = 117;BA.debugLine="Private Sub INICIAR_Click";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 118;BA.debugLine="Usuario = Nombre.Text";
Debug.ShouldStop(2097152);
...
Debug.ShouldStop(4194304);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 120;BA.debugLine="Activity.LoadLayout(\"Pantalla2\")";
Debug.ShouldStop(8388608);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Pantalla2")),main.mostCurrent.activityBA);
 BA.debugLineNum = 121;BA.debugLine="Panel1.Visible=True";
Debug.ShouldStop(16777216);
main.mostCurrent._panel1.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 122;BA.debugLine="HiUsuario.Text= \"Hola \" & Usuario";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("Regresar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,292);
if (RapidSub.canDelegate("regresar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar_click");}
 BA.debugLineNum = 292;BA.debugLine="Private Sub Regresar_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 293;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(16);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 294;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(32);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 295;BA.debugLine="Panel2.Visible=True";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("Regresar2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,351);
if (RapidSub.canDelegate("regresar2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar2_click");}
 BA.debugLineNum = 351;BA.debugLine="Private Sub Regresar2_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 352;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(-2147483648);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 353;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(1);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
