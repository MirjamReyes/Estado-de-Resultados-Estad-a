...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.FinanzasC.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.FinanzasC.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public b4a.FinanzasC.main _main = null;
...
public String  _addformatdata(b4a.FinanzasC.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public b4a.FinanzasC.b4xformatter._b4xformatdata  _copyformatdata(b4a.FinanzasC.b4xformatter._b4xformatdata _data) throws Exception{
b4a.FinanzasC.b4xformatter._b4xformatdata _d = null;
...
_d = new b4a.FinanzasC.b4xformatter._b4xformatdata();
...
public b4a.FinanzasC.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
b4a.FinanzasC.b4xformatter._b4xformatdata _d = null;
...
b4a.FinanzasC.b4xformatter._b4xformatdata _data = null;
...
public b4a.FinanzasC.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (b4a.FinanzasC.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public b4a.FinanzasC.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
b4a.FinanzasC.b4xformatter._b4xformatdata _d = null;
...
_d = (b4a.FinanzasC.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public b4a.FinanzasC.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
