...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("EstadoResultados")),main.mostCurrent.activityBA);
 BA.debugLineNum = 155;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(67108864);
_cell = RemoteObject.createNew ("de.donmanfred.XSSFCellwrapper");
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 156;BA.debugLine="Cell.IsInitialized";
Debug.ShouldStop(134217728);
_cell.runVoidMethod ("IsInitialized");
 BA.debugLineNum = 157;BA.debugLine="Log(Cell.StringCellValue)";
Debug.ShouldStop(268435456);
main.mostCurrent.__c.runVoidMethod ("LogImpl","0524335",_cell.runMethod(true,"getStringCellValue"),0);
 BA.debugLineNum = 158;BA.debugLine="Dim Texto As String = Cell.StringCellValue";
Debug.ShouldStop(536870912);
_texto = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto", _texto);Debug.locals.put("Texto", _texto);
 BA.debugLineNum = 160;BA.debugLine="Concepto= Texto";
Debug.ShouldStop(-2147483648);
main.mostCurrent._concepto = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.LabelWrapper"), _texto);
