...
try {
		Debug.PushSubsStack("Activity_Create (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,86);
...
Debug.ShouldStop(2097152);
 BA.debugLineNum = 88;BA.debugLine="Activity.LoadLayout(\"Pantalla1\")";
...
if (_firsttime.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 91;BA.debugLine="formatter.Initialize";
Debug.ShouldStop(67108864);
main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_initialize" /*RemoteObject*/ ,main.processBA);
 BA.debugLineNum = 92;BA.debugLine="Dim DefaultFormat As B4XFormatData = formatter.G";
...
_defaultformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ );Debug.locals.put("DefaultFormat", _defaultformat);Debug.locals.put("DefaultFormat", _defaultformat);
 BA.debugLineNum = 93;BA.debugLine="DefaultFormat.MaximumFractions = 2";
Debug.ShouldStop(268435456);
_defaultformat.setField ("MaximumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 94;BA.debugLine="DefaultFormat.MinimumFractions = 2";
Debug.ShouldStop(536870912);
_defaultformat.setField ("MinimumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 95;BA.debugLine="DefaultFormat.Prefix = \"$ \"";
Debug.ShouldStop(1073741824);
_defaultformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ "));
 BA.debugLineNum = 96;BA.debugLine="Dim NegativeFormat As B4XFormatData = formatter.";
...
_negativeformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(_defaultformat));Debug.locals.put("NegativeFormat", _negativeformat);Debug.locals.put("NegativeFormat", _negativeformat);
 BA.debugLineNum = 97;BA.debugLine="NegativeFormat.TextColor = xui.Color_Red";
Debug.ShouldStop(1);
_negativeformat.setField ("TextColor" /*RemoteObject*/ ,main._xui.getField(true,"Color_Red"));
 BA.debugLineNum = 98;BA.debugLine="NegativeFormat.Prefix = \"$ (\"";
Debug.ShouldStop(2);
_negativeformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ ("));
 BA.debugLineNum = 99;BA.debugLine="NegativeFormat.Postfix = \")\"";
Debug.ShouldStop(4);
_negativeformat.setField ("Postfix" /*RemoteObject*/ ,BA.ObjectToString(")"));
 BA.debugLineNum = 100;BA.debugLine="NegativeFormat.FormatFont = xui.CreateDefaultBol";
Debug.ShouldStop(8);
_negativeformat.setField ("FormatFont" /*RemoteObject*/ ,main._xui.runMethod(false,"CreateDefaultBoldFont",(Object)(BA.numberCast(float.class, 15))));
 BA.debugLineNum = 101;BA.debugLine="formatter.AddFormatData(NegativeFormat, formatte";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("Activity_Pause (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,110);
...
try {
		Debug.PushSubsStack("Activity_Resume (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,106);
...
try {
		Debug.PushSubsStack("Analisis_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,150);
...
RemoteObject _cell = RemoteObject.declareNull("de.donmanfred.XSSFCellwrapper");
 BA.debugLineNum = 150;BA.debugLine="Private Sub Analisis_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 152;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(8388608);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 153;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 155;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(67108864);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 156;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(134217728);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 158;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
Debug.ShouldStop(536870912);
...
_sheet = main._xls.runMethod(false,"getSheetAt",(Object)(main._xls.runMethod(true,"getActiveSheetIndex")));Debug.locals.put("sheet", _sheet);Debug.locals.put("sheet", _sheet);
 BA.debugLineNum = 161;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(1);
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 162;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(2);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 164;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(8);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 166;BA.debugLine="Ingresos_ = Cell.NumericCellValue";
Debug.ShouldStop(32);
main._ingresos_ = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 168;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(128);
...
main._gop = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 172;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(2048);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 174;BA.debugLine="UtilidadB = Cell.NumericCellValue";
Debug.ShouldStop(8192);
main._utilidadb = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 176;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(32768);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 178;BA.debugLine="Gadm = Cell.NumericCellValue";
Debug.ShouldStop(131072);
main._gadm = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 180;BA.debugLine="row=sheet.getRow(5)";
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 182;BA.debugLine="UtilidadOai = Cell.NumericCellValue";
Debug.ShouldStop(2097152);
main._utilidadoai = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 184;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(8388608);
...
Debug.ShouldStop(16777216);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 186;BA.debugLine="Impuestos = Cell.NumericCellValue";
Debug.ShouldStop(33554432);
main._impuestos = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 188;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(134217728);
...
Debug.ShouldStop(268435456);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 190;BA.debugLine="UOperativaDesp_Imp = Cell.NumericCellValue";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("Boton_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,130);
...
_sf = _fd.runMethod(false,"ShowAsync",(Object)(BA.ObjectToCharSequence("Seleccionar Archivo")),(Object)(BA.ObjectToString("SELECCIONAR")),(Object)(BA.ObjectToString("Cancelar")),(Object)(BA.ObjectToString("")),main.mostCurrent.activityBA,(Object)((parent.mostCurrent.__c.getField(false,"Null"))),(Object)(parent.mostCurrent.__c.getField(true,"False")));Debug.locals.put("sf", _sf);Debug.locals.put("sf", _sf);
 BA.debugLineNum = 137;BA.debugLine="Wait For (sf) Dialog_Result(Result As Int)";
Debug.ShouldStop(256);
...
//C
this.state = 4;
 BA.debugLineNum = 139;BA.debugLine="Log(\"File path: \" & fd.FilePath)";
...
parent.mostCurrent._archivo = _fd.runMethod(true,"getChosenName");
 BA.debugLineNum = 141;BA.debugLine="Log(\"File name: \" & archivo)";
Debug.ShouldStop(4096);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","4458763",RemoteObject.concat(RemoteObject.createImmutable("File name: "),parent.mostCurrent._archivo),0);
 if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 143;BA.debugLine="Label1.Text = \"Ruta = \" & fd.FilePath";
...
parent.mostCurrent._label1.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Ruta = "),_fd.runMethod(true,"getFilePath"))));
 BA.debugLineNum = 144;BA.debugLine="Label2.Text = \"Nombre del Archivo = \" & fd.Chosen";
Debug.ShouldStop(32768);
parent.mostCurrent._label2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Nombre del Archivo = "),_fd.runMethod(true,"getChosenName"))));
 BA.debugLineNum = 146;BA.debugLine="Log(\"File path: \" & archivo)";
Debug.ShouldStop(131072);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","4458768",RemoteObject.concat(RemoteObject.createImmutable("File path: "),parent.mostCurrent._archivo),0);
...
try {
		Debug.PushSubsStack("ER_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,195);
...
RemoteObject _texto1 = RemoteObject.createImmutable("");
 BA.debugLineNum = 195;BA.debugLine="Private Sub ER_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 196;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(8);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 197;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(16);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 199;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
Debug.ShouldStop(64);
_sheet = RemoteObject.createNew ("de.donmanfred.XLSSheetwrapper");
_sheet = main._xls.runMethod(false,"getSheetAt",(Object)(main._xls.runMethod(true,"getActiveSheetIndex")));Debug.locals.put("sheet", _sheet);Debug.locals.put("sheet", _sheet);
...
Debug.ShouldStop(1024);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 204;BA.debugLine="Activity.LoadLayout(\"EstadoResultados\")";
Debug.ShouldStop(2048);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("EstadoResultados")),main.mostCurrent.activityBA);
 BA.debugLineNum = 205;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(4096);
_row = RemoteObject.createNew ("de.donmanfred.XSSFRowwrapper");
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 206;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(8192);
_cell = RemoteObject.createNew ("de.donmanfred.XSSFCellwrapper");
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 208;BA.debugLine="Dim Texto1 As String = NumberFormat2(0, 1, 2, 2,";
Debug.ShouldStop(32768);
...
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 210;BA.debugLine="Concepto.text= Texto1";
Debug.ShouldStop(131072);
main.mostCurrent._concepto.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 212;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(524288);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 1))));Debug.locals.put("row", _row);
 BA.debugLineNum = 213;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(1048576);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 214;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(2097152);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 216;BA.debugLine="Concepto1.text= Texto1";
Debug.ShouldStop(8388608);
main.mostCurrent._concepto1.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 218;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(33554432);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
 BA.debugLineNum = 219;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(67108864);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 220;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(134217728);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 221;BA.debugLine="Concepto2.text= Texto1";
Debug.ShouldStop(268435456);
main.mostCurrent._concepto2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 223;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(1073741824);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(1);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 226;BA.debugLine="Concepto3.text= Texto1";
Debug.ShouldStop(2);
main.mostCurrent._concepto3.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 228;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(8);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
 BA.debugLineNum = 229;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(16);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 230;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(32);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 231;BA.debugLine="Concepto4.text= Texto1";
Debug.ShouldStop(64);
main.mostCurrent._concepto4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 233;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(256);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
 BA.debugLineNum = 234;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(512);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 235;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(1024);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 236;BA.debugLine="Concepto5.text= Texto1";
Debug.ShouldStop(2048);
main.mostCurrent._concepto5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 238;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(8192);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
 BA.debugLineNum = 239;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(16384);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 240;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(32768);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 241;BA.debugLine="Concepto6.text= Texto1";
Debug.ShouldStop(65536);
main.mostCurrent._concepto6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 243;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(262144);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 244;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(524288);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 245;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(1048576);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 246;BA.debugLine="Concepto7.text= Texto1";
Debug.ShouldStop(2097152);
main.mostCurrent._concepto7.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 248;BA.debugLine="row=sheet.getRow(0)";
Debug.ShouldStop(8388608);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);
 BA.debugLineNum = 249;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(16777216);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 250;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(33554432);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 251;BA.debugLine="Datos.text= Texto1";
Debug.ShouldStop(67108864);
main.mostCurrent._datos.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 253;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(268435456);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 1))));Debug.locals.put("row", _row);
...
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 256;BA.debugLine="Datos1.text= Texto1";
Debug.ShouldStop(-2147483648);
main.mostCurrent._datos1.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 258;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(2);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
 BA.debugLineNum = 259;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(4);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 260;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(8);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 261;BA.debugLine="Datos2.text= Texto1";
Debug.ShouldStop(16);
main.mostCurrent._datos2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 263;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(64);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(256);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 266;BA.debugLine="Datos3.text= Texto1";
Debug.ShouldStop(512);
main.mostCurrent._datos3.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 268;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(2048);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
 BA.debugLineNum = 269;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(4096);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 270;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(8192);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 271;BA.debugLine="Datos4.text= Texto1";
Debug.ShouldStop(16384);
main.mostCurrent._datos4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 273;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(65536);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(262144);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 276;BA.debugLine="Datos5.text= Texto1";
Debug.ShouldStop(524288);
main.mostCurrent._datos5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 278;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(2097152);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
 BA.debugLineNum = 279;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(4194304);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 280;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(8388608);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 281;BA.debugLine="Datos6.text= Texto1";
Debug.ShouldStop(16777216);
main.mostCurrent._datos6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 283;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(67108864);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 284;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(134217728);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 285;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(268435456);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 286;BA.debugLine="Datos7.text= Texto1";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("info_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,124);
if (RapidSub.canDelegate("info_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","info_click");}
 BA.debugLineNum = 124;BA.debugLine="Private Sub info_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 125;BA.debugLine="MsgboxAsync(\"Recuerda verificar que el archivo ele";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("infoUB_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,402);
if (RapidSub.canDelegate("infoub_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoub_click");}
 BA.debugLineNum = 402;BA.debugLine="Private Sub infoUB_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 403;BA.debugLine="MsgboxAsync(\"La utilidad bruta, también conocida";
Debug.ShouldStop(262144);
main.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("La utilidad bruta, también conocida como utilidad de las ventas o ingresos brutos, es la ganancia que obtiene una compañía después de deducir los costos asociados con la fabricación y venta de sus productos, o los costos asociados con la prestación de sus servicios. ")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("¿Que es la Utilidad Bruta?"))),main.processBA);
...
try {
		Debug.PushSubsStack("infoUM_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,406);
if (RapidSub.canDelegate("infoum_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoum_click");}
 BA.debugLineNum = 406;BA.debugLine="Private Sub infoUM_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 407;BA.debugLine="MsgboxAsync(\"La utilidad de operación u operacion";
Debug.ShouldStop(4194304);
main.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("La utilidad de operación u operacional es un valor contable que mide la ganancia obtenida por una empresa a través de sus principales operaciones comerciales, excluyendo deducciones por los intereses e impuestos ")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("¿Que es la Utilidad de Operación?"))),main.processBA);
...
try {
		Debug.PushSubsStack("Ingresos_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,295);
if (RapidSub.canDelegate("ingresos_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","ingresos_click");}
 BA.debugLineNum = 295;BA.debugLine="Private Sub Ingresos_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 296;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(128);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 303;BA.debugLine="Activity.LoadLayout(\"Ingresos_gastos\")";
Debug.ShouldStop(16384);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Ingresos_gastos")),main.mostCurrent.activityBA);
 BA.debugLineNum = 354;BA.debugLine="mbc1.LegendShapeSize = 7.0	    'this line of code";
Debug.ShouldStop(2);
main.mostCurrent._mbc1.runVoidMethod ("setLegendShapeSize",BA.numberCast(float.class, 7.0));
 BA.debugLineNum = 355;BA.debugLine="mbc1.setTheLegendPositionAndForm(\"BELOW_CHART_CEN";
Debug.ShouldStop(4);
...
main.mostCurrent._mbc1.runVoidMethod ("setBarColors",RemoteObject.createNewArray("int",new int[] {12},new Object[] {main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan")}));
 BA.debugLineNum = 371;BA.debugLine="mbc1.LegendText = Array As String(\"Ingresos\", \"G,";
Debug.ShouldStop(262144);
main.mostCurrent._mbc1.runVoidMethod ("setLegendText",RemoteObject.createNewArray("String",new int[] {7},new Object[] {BA.ObjectToString("Ingresos"),BA.ObjectToString("G,Operacionales"),BA.ObjectToString("Utilidad Bruta"),BA.ObjectToString("G. Admin."),BA.ObjectToString("Utilidad O. AI."),BA.ObjectToString("Impuestos"),RemoteObject.createImmutable("Utilidad O. DI")}));
 BA.debugLineNum = 372;BA.debugLine="mbc1.ChartData = Array As Float(Ingresos_, GOp, U";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("INICIAR_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,114);
if (RapidSub.canDelegate("iniciar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","iniciar_click");}
 BA.debugLineNum = 114;BA.debugLine="Private Sub INICIAR_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 115;BA.debugLine="Usuario = Nombre.Text";
Debug.ShouldStop(262144);
...
Debug.ShouldStop(524288);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 117;BA.debugLine="Activity.LoadLayout(\"Pantalla2\")";
Debug.ShouldStop(1048576);
...
main.mostCurrent._panel1.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 119;BA.debugLine="HiUsuario.Text= \"Hola \" & Usuario";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("Regresar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,289);
if (RapidSub.canDelegate("regresar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar_click");}
 BA.debugLineNum = 289;BA.debugLine="Private Sub Regresar_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 290;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(2);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 291;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(4);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 292;BA.debugLine="Panel2.Visible=True";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("Regresar2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,397);
if (RapidSub.canDelegate("regresar2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar2_click");}
 BA.debugLineNum = 397;BA.debugLine="Private Sub Regresar2_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 398;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(8192);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 399;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(16384);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
