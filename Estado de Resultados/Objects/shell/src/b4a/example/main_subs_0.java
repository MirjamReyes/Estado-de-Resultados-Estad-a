...
Debug.ShouldStop(32768);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","2458763",RemoteObject.concat(RemoteObject.createImmutable("File name: "),parent.mostCurrent._archivo),0);
 if (true) break;
...
Debug.ShouldStop(1048576);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","2458768",RemoteObject.concat(RemoteObject.createImmutable("File path: "),parent.mostCurrent._archivo),0);
...
try {
		Debug.PushSubsStack("infoUB_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,405);
if (RapidSub.canDelegate("infoub_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoub_click");}
 BA.debugLineNum = 405;BA.debugLine="Private Sub infoUB_Click";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("infoUM_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,409);
if (RapidSub.canDelegate("infoum_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","infoum_click");}
 BA.debugLineNum = 409;BA.debugLine="Private Sub infoUM_Click";
Debug.ShouldStop(16777216);
...
Debug.ShouldStop(1024);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 306;BA.debugLine="Activity.LoadLayout(\"Ingresos_gastos\")";
Debug.ShouldStop(131072);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Ingresos_gastos")),main.mostCurrent.activityBA);
 BA.debugLineNum = 357;BA.debugLine="mbc1.LegendShapeSize = 7.0	    'this line of code";
Debug.ShouldStop(16);
main.mostCurrent._mbc1.runVoidMethod ("setLegendShapeSize",BA.numberCast(float.class, 7.0));
 BA.debugLineNum = 358;BA.debugLine="mbc1.setTheLegendPositionAndForm(\"BELOW_CHART_CEN";
Debug.ShouldStop(32);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendPositionAndForm",(Object)(BA.ObjectToString("BELOW_CHART_CENTER")),(Object)(RemoteObject.createImmutable("CIRCLE")));
 BA.debugLineNum = 360;BA.debugLine="mbc1.TheLegendColor = Colors.Blue";
Debug.ShouldStop(128);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 361;BA.debugLine="mbc1.TheLegendTextSize = 15.0";
Debug.ShouldStop(256);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendTextSize",BA.numberCast(float.class, 15.0));
 BA.debugLineNum = 362;BA.debugLine="mbc1.LegendTitle = \"Datos\"";
Debug.ShouldStop(512);
main.mostCurrent._mbc1.runVoidMethod ("setLegendTitle",BA.ObjectToString("Datos"));
 BA.debugLineNum = 364;BA.debugLine="mbc1.ChartDescription = \"\"";
Debug.ShouldStop(2048);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescription",BA.ObjectToString(""));
 BA.debugLineNum = 365;BA.debugLine="mbc1.ChartDescriptionColor = Colors.Blue";
Debug.ShouldStop(4096);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 366;BA.debugLine="mbc1.ChartDescriptionTextSize = 15";
Debug.ShouldStop(8192);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionTextSize",BA.numberCast(float.class, 15));
 BA.debugLineNum = 369;BA.debugLine="mbc1.ValueTextColor = Colors.Black";
Debug.ShouldStop(65536);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 370;BA.debugLine="mbc1.ValueTextSize = 10.0";
Debug.ShouldStop(131072);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextSize",BA.numberCast(int.class, 10.0));
 BA.debugLineNum = 373;BA.debugLine="mbc1.BarColors = Array As Int(Colors.Blue, Colors";
Debug.ShouldStop(1048576);
main.mostCurrent._mbc1.runVoidMethod ("setBarColors",RemoteObject.createNewArray("int",new int[] {12},new Object[] {main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Yellow"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan")}));
 BA.debugLineNum = 374;BA.debugLine="mbc1.LegendText = Array As String(\"Ingresos\", \"G,";
Debug.ShouldStop(2097152);
main.mostCurrent._mbc1.runVoidMethod ("setLegendText",RemoteObject.createNewArray("String",new int[] {7},new Object[] {BA.ObjectToString("Ingresos"),BA.ObjectToString("G,Operacionales"),BA.ObjectToString("Utilidad Bruta"),BA.ObjectToString("G. Admin."),BA.ObjectToString("Utilidad O. AI."),BA.ObjectToString("Impuestos"),RemoteObject.createImmutable("Utilidad O. DI")}));
 BA.debugLineNum = 375;BA.debugLine="mbc1.ChartData = Array As Float(Ingresos_, GOp, U";
Debug.ShouldStop(4194304);
...
main.mostCurrent._mbc1.runVoidMethod ("setGridBackgroundColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 BA.debugLineNum = 380;BA.debugLine="mbc1.DrawBorders = True";
Debug.ShouldStop(134217728);
main.mostCurrent._mbc1.runVoidMethod ("setDrawBorders",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 381;BA.debugLine="mbc1.DrawGridBackground = True";
Debug.ShouldStop(268435456);
main.mostCurrent._mbc1.runVoidMethod ("setDrawGridBackground",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 382;BA.debugLine="mbc1.DrawValueAboveBar = False";
Debug.ShouldStop(536870912);
main.mostCurrent._mbc1.runVoidMethod ("setDrawValueAboveBar",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 383;BA.debugLine="mbc1.PinchZoom = True";
Debug.ShouldStop(1073741824);
main.mostCurrent._mbc1.runVoidMethod ("setPinchZoom",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 384;BA.debugLine="mbc1.ScaleEnabled = True";
Debug.ShouldStop(-2147483648);
main.mostCurrent._mbc1.runVoidMethod ("setScaleEnabled",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 385;BA.debugLine="mbc1.BorderColor = Colors.White";
Debug.ShouldStop(1);
main.mostCurrent._mbc1.runVoidMethod ("setBorderColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 BA.debugLineNum = 386;BA.debugLine="mbc1.BorderWidth = 3.0";
Debug.ShouldStop(2);
main.mostCurrent._mbc1.runVoidMethod ("setBorderWidth",BA.numberCast(float.class, 3.0));
 BA.debugLineNum = 389;BA.debugLine="mbc1.XaxisLabelPosition = \"TOP\"";
Debug.ShouldStop(16);
main.mostCurrent._mbc1.runVoidMethod ("setXaxisLabelPosition",BA.ObjectToString("TOP"));
 BA.debugLineNum = 390;BA.debugLine="mbc1.XaxisTextSize = 7.0";
Debug.ShouldStop(32);
main.mostCurrent._mbc1.runVoidMethod ("setXaxisTextSize",BA.numberCast(float.class, 7.0));
 BA.debugLineNum = 391;BA.debugLine="mbc1.XaxisTextColor = Colors.Blue";
Debug.ShouldStop(64);
main.mostCurrent._mbc1.runVoidMethod ("setXaxisTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
 BA.debugLineNum = 393;BA.debugLine="mbc1.DrawYaxisGridLines = True";
Debug.ShouldStop(256);
main.mostCurrent._mbc1.runVoidMethod ("setDrawYaxisGridLines",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 394;BA.debugLine="mbc1.YaxisTextColor = Colors.DarkGray";
Debug.ShouldStop(512);
main.mostCurrent._mbc1.runVoidMethod ("setYaxisTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"DarkGray"));
 BA.debugLineNum = 395;BA.debugLine="mbc1.YaxisTextSize = 10.0";
Debug.ShouldStop(1024);
main.mostCurrent._mbc1.runVoidMethod ("setYaxisTextSize",BA.numberCast(float.class, 10.0));
 BA.debugLineNum = 397;BA.debugLine="mbc1.BarData = 7   'this number must be the same";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("Regresar2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,400);
if (RapidSub.canDelegate("regresar2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar2_click");}
 BA.debugLineNum = 400;BA.debugLine="Private Sub Regresar2_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 401;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(65536);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 402;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(131072);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
