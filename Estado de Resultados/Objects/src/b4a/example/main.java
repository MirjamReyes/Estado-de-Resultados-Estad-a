...
RDebugUtils.currentLine=720899;
 //BA.debugLineNum = 720899;BA.debugLine="Activity.LoadLayout(\"ScrollView\")";
mostCurrent._activity.LoadLayout("ScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=720900;
 //BA.debugLineNum = 720900;BA.debugLine="ScrollView1.Panel.LoadLayout(\"ingresos_gastos\")";
mostCurrent._scrollview1.getPanel().LoadLayout("ingresos_gastos",mostCurrent.activityBA);
RDebugUtils.currentLine=720901;
 //BA.debugLineNum = 720901;BA.debugLine="ScrollView1.Panel.Width=Panelbarras.Width";
mostCurrent._scrollview1.getPanel().setWidth(mostCurrent._panelbarras.getWidth());
RDebugUtils.currentLine=720912;
 //BA.debugLineNum = 720912;BA.debugLine="mbc1.LegendShapeSize = 7.0	    'this line of code";
mostCurrent._mbc1.setLegendShapeSize((float) (7.0));
RDebugUtils.currentLine=720913;
 //BA.debugLineNum = 720913;BA.debugLine="mbc1.setTheLegendPositionAndForm(\"BELOW_CHART_CEN";
mostCurrent._mbc1.setTheLegendPositionAndForm("BELOW_CHART_CENTER","CIRCLE");
RDebugUtils.currentLine=720915;
 //BA.debugLineNum = 720915;BA.debugLine="mbc1.TheLegendColor = Colors.Gray";
mostCurrent._mbc1.setTheLegendColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
RDebugUtils.currentLine=720916;
 //BA.debugLineNum = 720916;BA.debugLine="mbc1.TheLegendTextSize = 15.0";
mostCurrent._mbc1.setTheLegendTextSize((float) (15.0));
RDebugUtils.currentLine=720917;
 //BA.debugLineNum = 720917;BA.debugLine="mbc1.LegendTitle = \"\"";
mostCurrent._mbc1.setLegendTitle("");
RDebugUtils.currentLine=720918;
 //BA.debugLineNum = 720918;BA.debugLine="mbc1.ChartDescription = \"\"";
mostCurrent._mbc1.setChartDescription("");
RDebugUtils.currentLine=720919;
 //BA.debugLineNum = 720919;BA.debugLine="mbc1.ChartDescriptionColor = 0XFFFFA500";
mostCurrent._mbc1.setChartDescriptionColor(((int)0xffffa500));
RDebugUtils.currentLine=720920;
 //BA.debugLineNum = 720920;BA.debugLine="mbc1.ChartDescriptionTextSize = 11";
mostCurrent._mbc1.setChartDescriptionTextSize((float) (11));
RDebugUtils.currentLine=720922;
 //BA.debugLineNum = 720922;BA.debugLine="mbc1.ValueTextColor = Colors.Black";
mostCurrent._mbc1.setValueTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=720923;
 //BA.debugLineNum = 720923;BA.debugLine="mbc1.ValueTextSize = 9.0";
mostCurrent._mbc1.setValueTextSize((int) (9.0));
RDebugUtils.currentLine=720926;
 //BA.debugLineNum = 720926;BA.debugLine="mbc1.BarColors = Array As Int(Colors.Blue, Colors";
...
RDebugUtils.currentLine=720927;
 //BA.debugLineNum = 720927;BA.debugLine="mbc1.LegendText = Array As String(\"Ingresos\", \"G,";
...
RDebugUtils.currentLine=720928;
 //BA.debugLineNum = 720928;BA.debugLine="mbc1.ChartData = Array As Float (Ingresos_, GOp,";
