...
anywheresoftware.b4a.keywords.Common.LogImpl("3524292",("ActiveSheetIndex="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_xls.getActiveSheetIndex()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524294",("ActiveSheet.ActiveCell="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sheet.getActiveCell()))+""),0);
RDebugUtils.currentLine=524295;
 //BA.debugLineNum = 524295;BA.debugLine="Log($\"ActiveSheet.hasComments=${sheet.hasComments";
anywheresoftware.b4a.keywords.Common.LogImpl("3524295",("ActiveSheet.hasComments="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_sheet.hasComments()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524298",("Row FirstRow="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_firstrow))+", LastRow="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_lastrow))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524305",("Row #"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_i))+" FirstCell="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_row.getFirstCellNum()))+", LastCell="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_row.getLastCellNum()))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524312",("Cell #"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_o))+""),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524315",("CellValueType="+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_cell.getCellType()))+""),0);
RDebugUtils.currentLine=524316;
 //BA.debugLineNum = 524316;BA.debugLine="Log(\"Raw:\"&Cell.RawValue)";
anywheresoftware.b4a.keywords.Common.LogImpl("3524316","Raw:"+_cell.getRawValue(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("3524318",_cell.getStringCellValue(),0);
RDebugUtils.currentLine=524319;
 //BA.debugLineNum = 524319;BA.debugLine="Dim Texto As String = Cell.StringCellValue";
_texto = _cell.getStringCellValue();
 }else 
{RDebugUtils.currentLine=524322;
 //BA.debugLineNum = 524322;BA.debugLine="else if Cell.CellType = 0 Then";
if (_cell.getCellType()==0) { 
RDebugUtils.currentLine=524323;
 //BA.debugLineNum = 524323;BA.debugLine="Log(Cell.NumericCellValue)";
anywheresoftware.b4a.keywords.Common.LogImpl("3524323",BA.NumberToString(_cell.getNumericCellValue()),0);
 }}
;
 };
 }
...
RDebugUtils.currentLine=524336;
 //BA.debugLineNum = 524336;BA.debugLine="Dim row As XSSFRow =sheet.getRow(2)";
_row = new de.donmanfred.XSSFRowwrapper();
...
RDebugUtils.currentLine=524337;
 //BA.debugLineNum = 524337;BA.debugLine="Dim Cell As XSSFCell =row.getCell(12)";
_cell = new de.donmanfred.XSSFCellwrapper();
_cell = _row.getCell((int) (12));
RDebugUtils.currentLine=524338;
 //BA.debugLineNum = 524338;BA.debugLine="Cell.IsInitialized";
_cell.IsInitialized();
RDebugUtils.currentLine=524339;
 //BA.debugLineNum = 524339;BA.debugLine="Log(Cell.StringCellValue)";
anywheresoftware.b4a.keywords.Common.LogImpl("3524339",_cell.getStringCellValue(),0);
RDebugUtils.currentLine=524344;
 //BA.debugLineNum = 524344;BA.debugLine="End Sub";
return "";
}
...
anywheresoftware.b4a.keywords.Common.LogImpl("3458761","File path: "+_fd.getFilePath(),0);
RDebugUtils.currentLine=458762;
 //BA.debugLineNum = 458762;BA.debugLine="Log(\"File name: \" & fd.ChosenName)";
anywheresoftware.b4a.keywords.Common.LogImpl("3458762","File name: "+_fd.getChosenName(),0);
 if (true) break;
