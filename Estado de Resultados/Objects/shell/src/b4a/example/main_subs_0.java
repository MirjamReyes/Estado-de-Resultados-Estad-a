...
Debug.ShouldStop(262144);
 BA.debugLineNum = 85;BA.debugLine="Activity.LoadLayout(\"Pantalla1\")";
...
if (_firsttime.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 88;BA.debugLine="formatter.Initialize";
Debug.ShouldStop(8388608);
main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_initialize" /*RemoteObject*/ ,main.processBA);
 BA.debugLineNum = 89;BA.debugLine="Dim DefaultFormat As B4XFormatData = formatter.G";
...
_defaultformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_getdefaultformat" /*RemoteObject*/ );Debug.locals.put("DefaultFormat", _defaultformat);Debug.locals.put("DefaultFormat", _defaultformat);
 BA.debugLineNum = 90;BA.debugLine="DefaultFormat.MaximumFractions = 2";
Debug.ShouldStop(33554432);
_defaultformat.setField ("MaximumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 91;BA.debugLine="DefaultFormat.MinimumFractions = 2";
Debug.ShouldStop(67108864);
_defaultformat.setField ("MinimumFractions" /*RemoteObject*/ ,BA.numberCast(int.class, 2));
 BA.debugLineNum = 92;BA.debugLine="DefaultFormat.Prefix = \"$ \"";
Debug.ShouldStop(134217728);
_defaultformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ "));
 BA.debugLineNum = 93;BA.debugLine="Dim NegativeFormat As B4XFormatData = formatter.";
...
_negativeformat = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_copyformatdata" /*RemoteObject*/ ,(Object)(_defaultformat));Debug.locals.put("NegativeFormat", _negativeformat);Debug.locals.put("NegativeFormat", _negativeformat);
 BA.debugLineNum = 94;BA.debugLine="NegativeFormat.TextColor = xui.Color_Red";
Debug.ShouldStop(536870912);
_negativeformat.setField ("TextColor" /*RemoteObject*/ ,main._xui.getField(true,"Color_Red"));
 BA.debugLineNum = 95;BA.debugLine="NegativeFormat.Prefix = \"$ (\"";
Debug.ShouldStop(1073741824);
_negativeformat.setField ("Prefix" /*RemoteObject*/ ,BA.ObjectToString("$ ("));
 BA.debugLineNum = 96;BA.debugLine="NegativeFormat.Postfix = \")\"";
Debug.ShouldStop(-2147483648);
_negativeformat.setField ("Postfix" /*RemoteObject*/ ,BA.ObjectToString(")"));
 BA.debugLineNum = 97;BA.debugLine="NegativeFormat.FormatFont = xui.CreateDefaultBol";
Debug.ShouldStop(1);
_negativeformat.setField ("FormatFont" /*RemoteObject*/ ,main._xui.runMethod(false,"CreateDefaultBoldFont",(Object)(BA.numberCast(float.class, 15))));
 BA.debugLineNum = 98;BA.debugLine="formatter.AddFormatData(NegativeFormat, formatte";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("Analisis_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,147);
...
RemoteObject _cell = RemoteObject.declareNull("de.donmanfred.XSSFCellwrapper");
 BA.debugLineNum = 147;BA.debugLine="Private Sub Analisis_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 149;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(1048576);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 150;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
...
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 152;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(8388608);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 153;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(16777216);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 155;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
Debug.ShouldStop(67108864);
...
_sheet = main._xls.runMethod(false,"getSheetAt",(Object)(main._xls.runMethod(true,"getActiveSheetIndex")));Debug.locals.put("sheet", _sheet);Debug.locals.put("sheet", _sheet);
 BA.debugLineNum = 158;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(536870912);
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 159;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(1073741824);
...
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 161;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(1);
...
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
 BA.debugLineNum = 166;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(32);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 167;BA.debugLine="Gadm = Cell.NumericCellValue";
Debug.ShouldStop(64);
main._gadm = BA.numberCast(float.class, _cell.runMethod(true,"getNumericCellValue"));
 BA.debugLineNum = 169;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(256);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
 BA.debugLineNum = 170;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(512);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 171;BA.debugLine="GOp = Cell.NumericCellValue";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("Boton_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,127);
...
_sf = _fd.runMethod(false,"ShowAsync",(Object)(BA.ObjectToCharSequence("Seleccionar Archivo")),(Object)(BA.ObjectToString("SELECCIONAR")),(Object)(BA.ObjectToString("Cancelar")),(Object)(BA.ObjectToString("si")),main.mostCurrent.activityBA,(Object)((parent.mostCurrent.__c.getField(false,"Null"))),(Object)(parent.mostCurrent.__c.getField(true,"False")));Debug.locals.put("sf", _sf);Debug.locals.put("sf", _sf);
 BA.debugLineNum = 134;BA.debugLine="Wait For (sf) Dialog_Result(Result As Int)";
Debug.ShouldStop(32);
...
//C
this.state = 4;
 BA.debugLineNum = 136;BA.debugLine="Log(\"File path: \" & fd.FilePath)";
Debug.ShouldStop(128);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","01114121",RemoteObject.concat(RemoteObject.createImmutable("File path: "),_fd.runMethod(true,"getFilePath")),0);
 BA.debugLineNum = 137;BA.debugLine="archivo = fd.ChosenName";
Debug.ShouldStop(256);
parent.mostCurrent._archivo = _fd.runMethod(true,"getChosenName");
 BA.debugLineNum = 138;BA.debugLine="Log(\"File name: \" & archivo)";
Debug.ShouldStop(512);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","01114123",RemoteObject.concat(RemoteObject.createImmutable("File name: "),parent.mostCurrent._archivo),0);
 if (true) break;
...
parent.mostCurrent._label2.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Archivo = "),_fd.runMethod(true,"getChosenName"))));
 BA.debugLineNum = 143;BA.debugLine="Log(\"File path: \" & archivo)";
Debug.ShouldStop(16384);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","01114128",RemoteObject.concat(RemoteObject.createImmutable("File path: "),parent.mostCurrent._archivo),0);
...
try {
		Debug.PushSubsStack("ER_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,176);
...
RemoteObject _texto1 = RemoteObject.createImmutable("");
 BA.debugLineNum = 176;BA.debugLine="Private Sub ER_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 177;BA.debugLine="File.Copy(File.DirAssets,archivo,File.DirInternal";
Debug.ShouldStop(65536);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(main.mostCurrent._archivo),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo));
 BA.debugLineNum = 178;BA.debugLine="xls.Initialize(\"\",File.Combine(File.DirInternal,a";
Debug.ShouldStop(131072);
main._xls.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(main.mostCurrent._archivo))));
 BA.debugLineNum = 180;BA.debugLine="Dim sheet As XLSSheet = xls.getSheetAt(xls.Active";
...
Debug.ShouldStop(8388608);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 185;BA.debugLine="Activity.LoadLayout(\"EstadoResultados\")";
Debug.ShouldStop(16777216);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("EstadoResultados")),main.mostCurrent.activityBA);
 BA.debugLineNum = 186;BA.debugLine="Dim row As XSSFRow =sheet.getRow(0)";
Debug.ShouldStop(33554432);
_row = RemoteObject.createNew ("de.donmanfred.XSSFRowwrapper");
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);Debug.locals.put("row", _row);
 BA.debugLineNum = 187;BA.debugLine="Dim Cell As XSSFCell =row.getCell(0)";
Debug.ShouldStop(67108864);
_cell = RemoteObject.createNew ("de.donmanfred.XSSFCellwrapper");
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);Debug.locals.put("Cell", _cell);
...
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 191;BA.debugLine="Concepto.text= Texto1";
Debug.ShouldStop(1073741824);
...
Debug.ShouldStop(256);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 202;BA.debugLine="Concepto2.text= Texto1";
Debug.ShouldStop(512);
main.mostCurrent._concepto2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 204;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(2048);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
 BA.debugLineNum = 205;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(4096);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 206;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(8192);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
...
Debug.ShouldStop(262144);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 212;BA.debugLine="Concepto4.text= Texto1";
Debug.ShouldStop(524288);
main.mostCurrent._concepto4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 214;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(2097152);
...
Debug.ShouldStop(8388608);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 217;BA.debugLine="Concepto5.text= Texto1";
Debug.ShouldStop(16777216);
main.mostCurrent._concepto5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 219;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(67108864);
...
Debug.ShouldStop(268435456);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 222;BA.debugLine="Concepto6.text= Texto1";
Debug.ShouldStop(536870912);
main.mostCurrent._concepto6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 224;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(-2147483648);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 225;BA.debugLine="Cell=row.getCell(0)";
Debug.ShouldStop(1);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 226;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(2);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 227;BA.debugLine="Concepto7.text= Texto1";
Debug.ShouldStop(4);
main.mostCurrent._concepto7.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 229;BA.debugLine="row=sheet.getRow(0)";
Debug.ShouldStop(16);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("row", _row);
 BA.debugLineNum = 230;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(32);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 231;BA.debugLine="Texto1 = Cell.StringCellValue";
Debug.ShouldStop(64);
_texto1 = _cell.runMethod(true,"getStringCellValue");Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 232;BA.debugLine="Datos.text= Texto1";
Debug.ShouldStop(128);
main.mostCurrent._datos.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 234;BA.debugLine="row=sheet.getRow(1)";
Debug.ShouldStop(512);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 1))));Debug.locals.put("row", _row);
 BA.debugLineNum = 235;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1024);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 236;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(2048);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 237;BA.debugLine="Datos1.text= Texto1";
Debug.ShouldStop(4096);
main.mostCurrent._datos1.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 239;BA.debugLine="row=sheet.getRow(2)";
Debug.ShouldStop(16384);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 2))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(65536);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 242;BA.debugLine="Datos2.text= Texto1";
Debug.ShouldStop(131072);
main.mostCurrent._datos2.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 244;BA.debugLine="row=sheet.getRow(3)";
Debug.ShouldStop(524288);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 3))));Debug.locals.put("row", _row);
 BA.debugLineNum = 245;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1048576);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 246;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(2097152);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 247;BA.debugLine="Datos3.text= Texto1";
Debug.ShouldStop(4194304);
main.mostCurrent._datos3.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 249;BA.debugLine="row=sheet.getRow(4)";
Debug.ShouldStop(16777216);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 4))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(67108864);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 252;BA.debugLine="Datos4.text= Texto1";
Debug.ShouldStop(134217728);
main.mostCurrent._datos4.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 254;BA.debugLine="row=sheet.getRow(5)";
Debug.ShouldStop(536870912);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 5))));Debug.locals.put("row", _row);
 BA.debugLineNum = 255;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(1073741824);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 256;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(-2147483648);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 257;BA.debugLine="Datos5.text= Texto1";
Debug.ShouldStop(1);
main.mostCurrent._datos5.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 259;BA.debugLine="row=sheet.getRow(6)";
Debug.ShouldStop(4);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 6))));Debug.locals.put("row", _row);
...
Debug.ShouldStop(16);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 262;BA.debugLine="Datos6.text= Texto1";
Debug.ShouldStop(32);
main.mostCurrent._datos6.runMethod(true,"setText",BA.ObjectToCharSequence(_texto1));
 BA.debugLineNum = 264;BA.debugLine="row=sheet.getRow(7)";
Debug.ShouldStop(128);
_row = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("de.donmanfred.XSSFRowwrapper"), _sheet.runMethod(false,"getRow",(Object)(BA.numberCast(int.class, 7))));Debug.locals.put("row", _row);
 BA.debugLineNum = 265;BA.debugLine="Cell=row.getCell(2)";
Debug.ShouldStop(256);
_cell = _row.runMethod(false,"getCell",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("Cell", _cell);
 BA.debugLineNum = 266;BA.debugLine="Texto1 = formatter.Format(Cell.NumericCellValue)";
Debug.ShouldStop(512);
_texto1 = main._formatter.runClassMethod (b4a.example.b4xformatter.class, "_format" /*RemoteObject*/ ,(Object)(_cell.runMethod(true,"getNumericCellValue")));Debug.locals.put("Texto1", _texto1);
 BA.debugLineNum = 267;BA.debugLine="Datos7.text= Texto1";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("info_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,121);
if (RapidSub.canDelegate("info_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","info_click");}
 BA.debugLineNum = 121;BA.debugLine="Private Sub info_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 122;BA.debugLine="MsgboxAsync(\"Recuerda verificar que el archivo ele";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("Ingresos_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,276);
if (RapidSub.canDelegate("ingresos_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","ingresos_click");}
 BA.debugLineNum = 276;BA.debugLine="Private Sub Ingresos_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 277;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(1048576);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 278;BA.debugLine="Activity.LoadLayout(\"Ingresos_gastos\")";
Debug.ShouldStop(2097152);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Ingresos_gastos")),main.mostCurrent.activityBA);
 BA.debugLineNum = 286;BA.debugLine="mbc1.LegendShapeSize = 7.0	    'this line of code";
Debug.ShouldStop(536870912);
main.mostCurrent._mbc1.runVoidMethod ("setLegendShapeSize",BA.numberCast(float.class, 7.0));
 BA.debugLineNum = 287;BA.debugLine="mbc1.setTheLegendPositionAndForm(\"BELOW_CHART_CEN";
Debug.ShouldStop(1073741824);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendPositionAndForm",(Object)(BA.ObjectToString("BELOW_CHART_CENTER")),(Object)(RemoteObject.createImmutable("CIRCLE")));
 BA.debugLineNum = 289;BA.debugLine="mbc1.TheLegendColor = Colors.Gray";
Debug.ShouldStop(1);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray"));
 BA.debugLineNum = 290;BA.debugLine="mbc1.TheLegendTextSize = 20.0";
Debug.ShouldStop(2);
main.mostCurrent._mbc1.runVoidMethod ("setTheLegendTextSize",BA.numberCast(float.class, 20.0));
 BA.debugLineNum = 291;BA.debugLine="mbc1.LegendTitle = \"\"";
Debug.ShouldStop(4);
main.mostCurrent._mbc1.runVoidMethod ("setLegendTitle",BA.ObjectToString(""));
 BA.debugLineNum = 292;BA.debugLine="mbc1.ChartDescription = \"\"";
Debug.ShouldStop(8);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescription",BA.ObjectToString(""));
 BA.debugLineNum = 293;BA.debugLine="mbc1.ChartDescriptionColor = 0XFFFFA500";
Debug.ShouldStop(16);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionColor",BA.numberCast(int.class, ((int)0xffffa500)));
 BA.debugLineNum = 294;BA.debugLine="mbc1.ChartDescriptionTextSize = 19";
Debug.ShouldStop(32);
main.mostCurrent._mbc1.runVoidMethod ("setChartDescriptionTextSize",BA.numberCast(float.class, 19));
 BA.debugLineNum = 296;BA.debugLine="mbc1.ValueTextColor = Colors.Black";
Debug.ShouldStop(128);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 BA.debugLineNum = 297;BA.debugLine="mbc1.ValueTextSize = 11.0";
Debug.ShouldStop(256);
main.mostCurrent._mbc1.runVoidMethod ("setValueTextSize",BA.numberCast(int.class, 11.0));
 BA.debugLineNum = 300;BA.debugLine="mbc1.BarColors = Array As Int(Colors.Blue, Colors";
Debug.ShouldStop(2048);
main.mostCurrent._mbc1.runVoidMethod ("setBarColors",RemoteObject.createNewArray("int",new int[] {4},new Object[] {main.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Green"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Magenta"),main.mostCurrent.__c.getField(false,"Colors").getField(true,"Cyan")}));
 BA.debugLineNum = 301;BA.debugLine="mbc1.LegendText = Array As String(\"Ingresos\", \"G,";
Debug.ShouldStop(4096);
main.mostCurrent._mbc1.runVoidMethod ("setLegendText",RemoteObject.createNewArray("String",new int[] {3},new Object[] {BA.ObjectToString("Ingresos"),BA.ObjectToString("G,Operacionales"),RemoteObject.createImmutable("G. Admin.")}));
 BA.debugLineNum = 302;BA.debugLine="mbc1.ChartData = Array As Float (Ingresos_, Gadm,";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("INICIAR_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,111);
if (RapidSub.canDelegate("iniciar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","iniciar_click");}
 BA.debugLineNum = 111;BA.debugLine="Private Sub INICIAR_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 112;BA.debugLine="Usuario = Nombre.Text";
Debug.ShouldStop(32768);
...
Debug.ShouldStop(65536);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 114;BA.debugLine="Activity.LoadLayout(\"Pantalla2\")";
Debug.ShouldStop(131072);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Pantalla2")),main.mostCurrent.activityBA);
 BA.debugLineNum = 115;BA.debugLine="Panel1.Visible=True";
Debug.ShouldStop(262144);
main.mostCurrent._panel1.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 116;BA.debugLine="HiUsuario.Text= \"Hola \" & Usuario";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("Regresar_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,270);
if (RapidSub.canDelegate("regresar_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar_click");}
 BA.debugLineNum = 270;BA.debugLine="Private Sub Regresar_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 271;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(16384);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 272;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(32768);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
 BA.debugLineNum = 273;BA.debugLine="Panel2.Visible=True";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("Regresar2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,321);
if (RapidSub.canDelegate("regresar2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","regresar2_click");}
 BA.debugLineNum = 321;BA.debugLine="Private Sub Regresar2_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 322;BA.debugLine="Activity.RemoveAllViews";
Debug.ShouldStop(2);
main.mostCurrent._activity.runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 323;BA.debugLine="Activity.LoadLayout(\"Analisis\")";
Debug.ShouldStop(4);
main.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Analisis")),main.mostCurrent.activityBA);
